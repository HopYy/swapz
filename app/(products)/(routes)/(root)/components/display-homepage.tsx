...
export const DisplayHomepage: React.FC<DisplayHomepageProps> = ({ products }) => (
    <>
    <div className="w-full h-96 relative overflow-hidden my-10 lg:rounded-xl">
        ...
        <h1 className="text-5xl font-black tracking-widest">Discover Our Top Picks</h1>
        </div>
    </div>
    <div className="flex-1 max-w-full overflow-hidden my-10">
        <h1 className="text-2xl font-black ml-4 mb-5 max-lg:text-center">Top Liked Selection</h1>
