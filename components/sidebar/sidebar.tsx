...
export const Sidebar = () => {
  ...
  return (
    <>
      <button
        className="fixed top-0 left-0 m-2 mt-4 p-1.5 z-20 shadow-md bg-gray-50 hover:bg-gray-100 rounded-lg md:hidden"
      ...
      <aside
        className={cn(
          'fixed -left-20 md:left-0 top-0 z-30 h-screen bg-white border-r md:sticky',
          expanded && 'left-0'
        )}
      >
            ...
            <ul className="px-3">
              {SidebarItemsLinks.map((link) => (
                <SidebarItemLink
                  ...
                  href={link.href}
                  className={
                    link.label === 'Dashboard' ? 'max-lg:hidden' : undefined
                  }
                >
                  {link.icon}
                </SidebarItemLink>
              ...
              {SidebarItemsDropdowns.map((dropdown) => (
                <SidebarItemDropdown
                  ...
                  className={
                    dropdown.label === 'Dashboard' ? 'lg:hidden' : undefined
                  }
                >
                  {dropdown.icon}
                </SidebarItemDropdown>
