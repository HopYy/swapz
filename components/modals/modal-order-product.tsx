...
export const ModalOrderItem: React.FC<ModalOrderItemProps> = ({
  orderItem,
}) => {
  ...
  return (
    <div className="w-screen h-screen fixed inset-0 flex justify-center items-center md:max-lg:pl-[76px]">
      <div
        ref={ref}
        className="w-full max-w-[700px] flex flex-col justify-center max-sm:h-screen bg-white rounded-2xl shadow-sm border p-4 max-sm:rounded-none"
      >
