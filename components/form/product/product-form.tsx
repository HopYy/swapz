                    ...
                    <div className="flex justify-center max-lg:flex-col">
                        <div className="flex-1 flex flex-col gap-4">
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="block text-sm font-semibold">Name product</FormLabel>
                                        <FormControl>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="block text-sm font-semibold">Description product</FormLabel>
                                        <FormControl>
                                            <Textarea className="h-80" placeholder="description..." disabled={loading} {...field} />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
                            ...
                            <div className="flex justify-center flex-wrap gap-4">
                                <div className="flex flex-wrap max-lg:justify-center gap-4">
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                <FormLabel className="block text-sm font-semibold text-center">Base price</FormLabel>
                                                <FormControl>
                                                    <InputNumber loading={loading} field={field} placeholder="euro" />
                                                </FormControl>
                                                <FormMessage />
                                            </FormItem>
                                        )}
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                <FormLabel className="block text-sm font-semibold text-center">Shipping options</FormLabel>
                                                <FormControl>
                                                    <ShippingBox value={field.value} disabled={loading} onChange={(value) => field.onChange(value)} />
                                                </FormControl>
                                                <FormMessage />
                                            </FormItem>
                                        )}
                                ...
                                <div className="flex flex-wrap max-lg:justify-center gap-4">
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                <FormLabel className="block text-sm font-semibold text-center">Product category</FormLabel>
                                                <FormControl>
                                                    <CategoriesBox value={field.value} disabled={loading} onChange={(value) => field.onChange(value)} />
                                                </FormControl>
                                                <FormMessage />
                                            </FormItem>
                                        )}
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                <FormLabel className="block text-sm font-semibold text-center">Product condition</FormLabel>
                                                <FormControl>
                                                    <ConditionsBox value={field.value} disabled={loading} onChange={(value) => field.onChange(value)} />
                                                </FormControl>
                                                <FormMessage />
                                            </FormItem>
                                        )}
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex items-start space-x-3 space-y-0 my-10 max-lg:justify-center">
                                            ...
                                            <div className="space-y-1 leading-none">
                                                <FormLabel>Enable product returns for dissatisfied customers</FormLabel>
                                            </div>
                                        </FormItem>
                                    )}
                                />
                        ...
                        <div className="h-fit p-4">
                            <h1 className="text-lg font-bold mb-5 text-center">Upload image</h1>
                            <FormField
                                control={form.control}
                                name="images"
                                render={({ field }) => (
