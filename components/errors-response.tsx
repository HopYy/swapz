...
export const NoProducts = () => {
  return (
    <div className="flex flex-col justify-center items-center py-5">
      <NoProductsSvg />
      <h1 className="text-gray-500 text-md font-meduim text-center">
        No products found
      </h1>
    </div>
  );
...
export const NoProductsCart = () => {
  return (
    <div className="flex flex-col justify-center items-center py-5">
      <NoProductsSvg />
      <h1 className="text-black text-md font-meduim text-center">
        Your shopping cart is empty!
      </h1>
      <Link
        href="/"
        className="text-sm text-gray-400 font-medium text-center hover:underline"
      >
        Add products
      </Link>
    </div>
